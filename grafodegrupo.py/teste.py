    ...
    if path == "raizes.json":
        hipoteses_data = {
            "Neurotipico": {
                "peso_base": 6,
                "tendencias": {
                    "Psicológicos": ["Boa capacidade de autocontrole", "Capacidade de adaptação", "Autoestima preservada"],
                    "Ambientais": ["Rotina estável", "Ambiente afetivo"],
                    "Individuais": ["Rede de apoio"]
                }
            },
            "TEA": {
                "peso_base": 4,
            ...
            "Fatores": {
                "Sintomas": {
                    "Psicológicos": {
                        ...
                        "Boa capacidade de autocontrole": 1,
